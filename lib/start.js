...
var httpdPort = parseInt(httpdConf.read(p.work_httpdconf, 'PORT'));
console.log(httpdPort);

portscanner.findAPortNotInUse(httpdPort, httpdPort + 100, '127.0.0.1', function (error, port) {
